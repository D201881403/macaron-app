...
const DERMA_TREATMENTS = {
  ...
  '术后护理指南': [
    { name: '染料激光术后护理', type: '术后护理', detail: '【深圳联合丽格】术后3天内仅用温水洗脸，禁蒸桑拿、禁暴晒；使用镇静修复面膜；第1晚皮肤可能紧绷但无不适，第3天可上妆且比术前更服帖；第7天红印可淡化约70%，肤色通透细腻；2-3次治疗后达理想状态；医生根据皮肤状态和耐受度调整方案' },
    { name: '水光针术后护理', type: '术后护理', detail: '【深圳联合丽格】术后6小时内注射区禁沾水、禁揉搓、禁用任何化妆品；24小时内禁化妆；可立即冷敷或医用冷敷贴缓解疼痛红肿；第1周每晚使用1片医用冷敷贴帮助恢复；3天内戒烟戒酒、禁辛辣刺激食物、禁使用刺激性化妆品或浓重遮瑕产品；1月内避免在注射区进行激光或光电治疗；严格物理防晒（帽子/口罩/伞）+SPF30 PA+++以上防晒霜；1-2个月一次，连续3次为一个治疗周期' },
    { name: '肉毒素注射术后护理', type: '术后护理', detail: '【深圳联合丽格】注射后现场观察20分钟无不适方可离院；4-6小时内保持直立、避免平躺、避免剧烈运动或按摩注射区域，防止药物移位（尤其防止渗入眼球附近引起眼肌麻痹）；6小时后方可清洗注射部位；24小时内禁饮酒；2周内禁用氨基糖苷类抗生素（庆大霉素、妥布霉素、奈替米星、卡那霉素等，会加强肉毒素毒性）；1周内避免用力咀嚼硬物或做夸张表情；2周后回访评估效果；可能出现轻微头痛可服对乙酰氨基酚止痛；局部淤青可冰敷' },
    { name: '玻尿酸填充术后护理', type: '术后护理', detail: '【深圳联合丽格】术后1-3天为肿胀高峰期，禁止用手触摸或揉搓填充部位以防移位；24小时内冰袋（裹毛巾）冷敷每次15分钟间隔30分钟消肿止痛；48小时后换40°C左右热敷促进吸收；1周内禁化妆（尤其粉底液，化学成分刺激伤口易感染）；避免剧烈运动（出汗带细菌进入针眼易发炎）；忌口辛辣、海鲜、牛羊肉等发物，饮食清淡+补充维生素C；晚11点前睡觉增强修复力；术后3天红肿可消退大半；3-5天恢复正常' },
    { name: '剥脱性点阵激光术后护理', type: '术后护理', detail: '【深圳联合丽格】CO2/铒激光术后红肿1-2天消退，结痂5-14天脱落；痂皮脱落前禁沾水，每日涂1-2次抗菌软膏（红霉素/莫匹罗星/夫西地酸等），涂第二次时轻柔去除前次药膏；可配合生长因子喷剂加速愈合（喷后15分钟再涂抗生素软膏，3-4小时后轻拭去，一日3-4次）；创面渗出结厚痂可用生理盐水浸湿无菌棉球轻拭；禁摩擦抓挠；痂皮脱落前禁涂化妆品护肤品、禁用洗面奶；物理防晒（帽子/口罩/伞）；口周治疗1月内禁咀嚼硬食；脱痂后恢复护肤但需持续防晒SPF30 PA+++以上' },
    { name: '非剥脱点阵激光术后护理', type: '术后护理', detail: '【深圳联合丽格】术后轻中度水肿性红斑约5天消退；可正常接触水分，建议用柔和氨基酸洁面清洁；1周内避免剧烈搓洗或卸妆动作；按医嘱使用医用保湿产品或保湿面膜修复皮肤屏障；持续物理防晒+SPF30 PA+++以上防晒霜' },
    { name: '强脉冲光/光子嫩肤术后护理', type: '术后护理', detail: '【深圳联合丽格】术后暂时性红斑约2小时消退；部分色斑处可能出现薄痂约1周脱落；可照常洗脸化妆但需严格防晒；物理防晒（帽子/口罩/伞）+SPF30 PA+++以上防晒霜；敏感肌加强皮肤保护层修复，使用温和医用级保湿产品' },
    { name: '调Q激光术后护理', type: '术后护理', detail: '【深圳联合丽格】术后红肿及结痂5-7天逐渐脱落；痂皮脱落前禁沾水，每日1-2次抗菌素软膏防感染（红霉素/莫匹罗星等）；脱痂后可恢复正常洗脸化妆；需长期持续防晒，物理防晒+SPF30 PA+++以上防晒霜' },
    { name: '皮秒激光术后护理', type: '术后护理', detail: '【深圳联合丽格】黄褐斑治疗：术后暂时性红斑约2小时消退，可正常洗脸护肤化妆；嫩肤治疗：轻微至中度红斑、水肿或紫癜5-7天内自行消退，清水轻柔洗脸+加强屏障修复+医用保湿产品/面膜；轻微瘙痒可服抗组胺药（如西替利嗪）；长期物理防晒+SPF30 PA+++以上防晒霜' },
    { name: '射频紧肤术后护理', type: '术后护理', detail: '【深圳联合丽格】术后轻度暂时性红斑、水肿1-2天自行消退无需特殊处理；可正常洗脸化妆；常规防晒；微针射频治疗护理同剥脱性激光（见上）' },
    { name: '光动力疗法（痤疮）术后护理', type: '术后护理', detail: '【深圳联合丽格】ALA-PDT术后2天内严格避光、避免强光源照射；持续使用SPF30 PA+++以上防晒霜；术后皮肤干涩需加强保湿，遵医嘱使用保湿型医学护肤品修复屏障；2-3天可能出现轻微水肿性红斑，可冷敷或冷喷缓解；可能出现小脓疱、薄痂皮或脱皮，1-2周自然恢复无需特殊处理；脓疱较多时遵医嘱外用或口服抗生素' },
    { name: '激光脱毛术后护理', type: '术后护理', detail: '【深圳联合丽格】术后无水疱则当天可沐浴，禁用沐浴露/肥皂，水温不可过热；注意保湿滋养肌肤；四肢暴露区域需穿长袖长裤+SPF30 PA+++以上防晒霜' },
    { name: '光动力（鲜红斑痣）术后护理', type: '术后护理', detail: '【深圳联合丽格】海姆泊芬光动力术后2周内严格避光，室内常规照明无碍；外出需全面防护（太阳镜、宽边帽、长袖衣裤、手套）；前3天肿胀明显可冷喷或湿敷无菌生理盐水/蒸馏水；禁抓挠摩擦结痂处，每日1-2次抗生素软膏防感染；结痂约2周自然脱落；术后1-2天不适可适量服止痛药' },
  ],
};
